...
:::image type="content" source="media/privacy/watermark-video-example.png" alt-text="Screenshot of a paused AI-generated video showing a gradient of colors. In the bottom right corner is a watermark that is the word AI-Generated.":::

In some cases, the video watermark might be the Copilot icon in the bottom right corner of the video.
...
Even if you decide to keep these watermarks turned off, [additional information is added to the metadata](#additional-information-added-to-the-metadata-of-content-thats-generated-or-altered-by-ai-in-microsoft-365) of the video and audio content that your users generate or alter by using AI in Microsoft 365.
...
:::image type="content" source="media/privacy/watermark-example-image-office.png" alt-text="AI-generated image of an empty conference with a window view of a city skyline. In the bottom right corner is a watermark that is the Copilot icon.":::
...
Even if your users don’t turn on watermarks for images, [additional information is added to the metadata](#additional-information-added-to-the-metadata-of-content-thats-generated-or-altered-by-ai-in-microsoft-365) of images that your users generate or alter by using AI in Microsoft 365.

## Additional information added to the metadata of content that’s generated or altered by AI in Microsoft 365

Even if you don’t turn on watermarks, additional information is added to the metadata of video and audio content that your users generate or alter by using AI in Microsoft 365. Additional information is also added to the metadata of images that your users generate or alter by using AI in Microsoft 365.

> [!NOTE]
> Currently, this additional information is added only to the metadata of images. We’re working on getting the information added to video and audio content, but we don’t have a specific time frame for when that will happen.

For example, the additional information added to the metadata of the content might include which AI model was used, which app generated the content, or when the content was generated. For more information, see the [Coalition for Content Provenance and Authenticity (C2PA) website](https://c2pa.org/).
