...
:::image type="content"  source="/microsoft-365/copilot/agent-essentials/media/m365-agents-admin-guide/agent-deploy-new.png" alt-text="Screenshot of deploying a new agent within M365 the Copilot Control System."  lightbox="/microsoft-365/copilot/agent-essentials/media/m365-agents-admin-guide/agent-deploy-new.png":::
