...
[Microsoft Purview](/purview/ai-microsoft-purview) and [Microsoft Security Copilot](/copilot/security/microsoft-security-copilot) help you govern AI across hybrid and multicloud environments like Azure, AWS, and Google Cloud.
