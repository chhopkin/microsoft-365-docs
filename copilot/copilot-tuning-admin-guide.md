...
:::image type="content" source="media/copilot-tuning-admin-guide/scenarios.png" alt-text="Tuning availability scenarios." lightbox="media/copilot-tuning-admin-guide/scenarios.png":::
...
:::image type="content" source="media/copilot-tuning-admin-guide/tuning-changes.png" alt-text="Behaviors that apply when tuning access changes." lightbox="media/copilot-tuning-admin-guide/tuning-changes.png":::
...
:::image type="content" source="media/copilot-tuning-admin-guide/snapshot-data.png" alt-text="How snapshot data is handled." lightbox="media/copilot-tuning-admin-guide/snapshot-data.png":::
