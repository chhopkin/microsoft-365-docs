...
| 5  | [Understand key Copilot Studio configuration settings](/microsoft-copilot-studio/guidance/sec-gov-config-settings)  |  tenant-level, environment-level, and agent-level settings in Copilot Studio.  |  |
