...
To turn on the Copilot AI disclaimer, you need to be assigned the AI Administrator role. For more information about the types of administrator roles, see Microsoft Entra built-in roles.
...
4. Review the disclaimer select Save to apply the setting.
