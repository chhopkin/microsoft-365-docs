...
Once you disconnect Anthropic, users can't use Anthropic’s AI models. After completing the steps to disconnect Anthropic in Microsoft 365, it may take several hours for the service to be fully disabled for your users.
