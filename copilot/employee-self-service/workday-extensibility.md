...
|Get government IDs |WorkdayGetGovernmentIDs |Returns government ID information associated with the requesting user's profile, including ID types, issued/expiration dates, and country. |What are my government IDs? |[View on GitHub](https://github.com/microsoft/CopilotStudioSamples/tree/main/EmployeeSelfServiceAgent/Workday/EmployeeScenarios/WorkdayGetGovernmentIDs) |
