...
**Example**: Suppose you have a "Country" column in your HR policies library. By mapping this to a managed property (like RefinableString100), This helps Employee Self-Service agent answer, "What is my parental leave policy in Germany?" with the correct, country-specific document, rather than a generic or irrelevant answer.
