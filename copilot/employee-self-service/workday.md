...
:::image type="content" source="media/Task4_Mng_AuthN_Policies.png" alt-text="A screenshot of the manage authentication policies report page.":::

2. Add the two generic users that you created in task 3.
3. Select **SAML** as Allowed Authentication Type if the generic user accounts are also created in Microsoft Entra. Otherwise, select **User Name Password**. If both methods are in use, then allow both.

:::image type="content" source="media/Task4_AuthN_Allowlist.png" alt-text="An image showing the Authentication AllowType window.":::

4. Ensure these generic user entries are at the top of the list.
5. Make sure you have the SAML option enabled for the **All Employees** security group along with any other required method in your workday environment.
6. **Execute Task - Activate All Pending Authentication Policy Changes** to activate all pending authentication policy changes. Required to finalize all authentic policy changes.
...
:::image type="content" source="media/Task6_SecConfig_Menu.png" alt-text="A screenshot of the Security Group window in the Security section showing Security Group and Assignable Role information. Maintain Domain Permissions for Security Group is selected under Assignable Role information. Test Membership and View Action Summary are not selected.":::
...
:::image type="content" source="media/Task7_DomainSecPolPerms.png" alt-text="A screenshot of the domain security policy permissions table.":::
...
1. If the **Integration Build** domain security policy isn't set, you need to add it.
    1. in the search textbox for this page, search for **integration build** and filter for **security**.
       ...
       :::image type="content" source="media/Task7_IntgBld_Security.png" alt-text="A screenshot of a search textbox with 'integration build' entered in. The top result showing is Security with a selectable 'Integration build' link underneath it.":::
    ...
    3. Select the ellipsis (…) menu, then select **Domain** > **Edit Security Policy Permissions**.
       ...
       :::image type="content" source="media/Task7_IntgBld_EditSecPolPerms.png" alt-text="A screenshot of the View domain window with a Domain sub-window.":::

    4. Add **ISSG_Generic_COPILOT** to **Integration Permissions**.

       :::image type="content" source="media/Task7_IntgBld_AddISSG_Generic.png" alt-text="A screenshot of a window with information in it.":::

    5. Run **Activate Pending Security Policy Changes**.

       :::image type="content" source="media/Task7_ActivatePendingChanges.png" alt-text="A screenshot of the activating pending security policy changes window.":::
