...
> [!WARNING]
> The preferred solution is per-user setting, which means every single user/maker who would like to apply any customizations must set the same solution as the preferred solution.
