---
title: Make Employee Self-Service Agent Multilingual
f1.keywords: NOCSH
...
| Costs | Language detection uses AI prompts and may incur usage costs for unlicensed users. | Dynamic Language Switching |[Set up an agent for Dynamic Language Switching](https://learn.microsoft.com/en-us/microsoft-copilot-studio/multilingual) |
| Ongoing maintenance | Custom language topics must be maintained and tested over time. | Dynamic Language Switching | [Set up an agent for dynamic Language Switching](https://learn.microsoft.com/en-us/microsoft-copilot-studio/multilingual)|
...
- Configure and test with a small audience before scaling.