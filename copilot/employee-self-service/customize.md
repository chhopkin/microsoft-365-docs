...
|Starter prompts                   |Copilot Studio overview page |Help end-users understand how to engage with the Employee Self-Service agent by adding up to 12 starter prompts. |
...
You can customize most of these elements in Copilot Studio by selecting the **Edit** button in the **Overview** section of the agent. You can also make changes to the landing page in Microsoft admin center. 
