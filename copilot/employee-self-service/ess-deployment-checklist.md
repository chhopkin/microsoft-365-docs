...
|[Manage agents for Microsoft 365 Copilot](../../../admin/manage/manage-copilot-agents-integrated-apps.md) |Explains how to publish, deploy, enable, or disable agents using the Microsoft 365 admin UI. |
