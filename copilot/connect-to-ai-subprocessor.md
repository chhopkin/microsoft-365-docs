...
To enable this change, Anthropic has onboarded as a Microsoft subprocessor. As part of this update, we are deprecating the previous option that allowed Microsoft tenants to use Anthropic as an Independent Data Processor (IDP). This change simplifies the experience and strengthens compliance and security under Microsoft’s enterprise framework.

As a subprocessor, Anthropic will operate with Microsoft oversight through contractual safeguards. The Microsoft [Product Terms](https://www.microsoft.com/licensing/terms?msockid=344e0e6ad66c6b3e19441848d7416abd) and [Microsoft Data Protection Addendum (DPA)](https://www.microsoft.com/licensing/docs/view/Microsoft-Products-and-Services-Data-Protection-Addendum-DPA?lang=18&msockid=344e0e6ad66c6b3e19441848d7416abd) applies to our use of Anthropic through this offering. It is also covered under our [Enterprise Data Protection](enterprise-data-protection.md).
...
> [!IMPORTANT]
> Anthropic models deployed in Microsoft 365 Copilot, Researcher, and Copilot Studio are currently excluded from EU Data Boundary and when applicable, in-country processing commitments. Learn more about how Anthropic models work with Microsoft 365 Copilot here: (link to new page for Anthropic – draft copy here). Customers within the European Union data boundary and customers in the UK will have Anthropic models disabled by default. Anthropic’s models are not supported in Government clouds (GCC, GCC High, DoD).

Your users can elect to use Anthropic's AI models in Microsoft 365 Copilot, with [Researcher](https://support.microsoft.com/topic/use-claude-with-researcher-in-microsoft-365-copilot-23e2503b-d73e-4abb-902d-b9814205a38a), [Copilot Studio](https://learn.microsoft.com/microsoft-copilot-studio/authoring-select-external-response-model), select Frontier features such as Word, Excel, PowerPoint, as well as [Agent mode in Excel](https://support.microsoft.com/office/agent-mode-in-excel-frontier-a2fd6fe4-97ac-416b-b89a-22f4d1357c7a). Anthropic’s AI models can help people in your organization with some of the following:
...
Microsoft is making Anthropic models available by default in certain regions for Microsoft 365 Copilot. In Microsoft 365 Copilot (web, desktop, and mobile), UI indicators will show when Anthropic and Claude models are in use. In Copilot Studio, creators must select the model during agent creation. In Agent mode for Excel and Researcher, users can select Try Claude.
...
2. On the **User access** page, select **AI providers of other external large language models as a subprocessor**.
...
## Anthropic as an Independent Data Processor (IDP) deprecation
