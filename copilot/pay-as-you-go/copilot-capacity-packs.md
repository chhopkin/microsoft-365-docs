...
With a prepaid capacity pack, you pay up front for a set number of messages (25,000 messages per month). These messages are used first for any Copilot Chat usage in your organization.

With pay-as-you-go billing, you pay per message for any usage beyond the prepaid capacity amount. If you run out of prepaid messages, Copilot Chat continues to work, and the extra usage is billed at the per-message pay-as-you-go billing rate.
...
- **Automatic switch to pay-as-you-go billing:** When consumption exceeds the allocated prepaid messages in the capacity pack, Copilot Chat automatically switches to pay-as-you-go billing for extra messages. There's no service interruption and users can continue using Copilot Chat as usual.
- **Billing for overages:** Any messages used beyond your prepaid allotment incur pay-as-you-go billing charges to the connected Azure subscription. These charges  appear on your next Azure invoice. For information about billing rates for messages, see [Billing rates and management - Microsoft Copilot Studio | Microsoft Learn](/microsoft-copilot-studio/requirements-messages-management).
- **Replenishment:** Copilot Studio capacity packs are subscription products. At the start of every monthly billing period, your 25,000 messages are replenished. You must have pay-as-you-go billing active as a safety net each month to cover any excess usage. Alternatively, you can top up with more capacity packs.
...
4. If your tenant has a Copilot Studio capacity pack, you see a checkbox for **Apply available Microsoft Copilot Studio message capacity to Microsoft 365 Copilot Chat**. Select the checkbox to indicate that you want to use your prepaid message capacity for Copilot Chat.
5. Select **Save**.
...
After you complete this step, your Copilot Chat environment has the specified number of messages allocated from your prepaid capacity. Any Copilot Chat agent messages consumed by users in this environment are drawn from the allocated prepaid pool first.
