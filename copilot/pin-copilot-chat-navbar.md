...
:::image type="content" source="../microsoft-365/media/pin-copilot-chat-new.png" alt-text="Screenshot of Microsoft 365 admin center showing selected checkbox for Pin Copilot Chat in Microsoft 365 apps setting." lightbox="media/pin-copilot-chat-new.png":::
