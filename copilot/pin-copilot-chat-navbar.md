...
:::image type="content" source="../microsoft-365/media/pin-copilot-microsoft-365-apps2.png" alt-text="Screenshot showing the Pin Copilot setting on the Copilot settings page in the Microsoft 365 admin center." lightbox="media/pin-copilot-microsoft-365-apps.png":::
