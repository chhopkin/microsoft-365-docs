...
- **Chat** with AI to help you prepare for a meeting or get answers to questions using work-based chat and web-grounded chat.
...
Microsoft Entra work or school accounts and personal Microsoft user accounts can access the Copilot app with a:
...
The following table shows the feature differences between a Microsoft 365 Copilot license and a Microsoft 365 subscription.
...
IT admins can configure some settings and features in the Microsoft 365 Copilot app. To learn more, see [Microsoft 365 Copilot app features that admins can control](microsoft-365-copilot-app-admin-settings.md).
