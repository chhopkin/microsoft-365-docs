...
2. [Turn on multifactor authentication](/microsoft-365/admin/security-and-compliance/m365b-account-security) (MFA). You can use security defaults to get set up right away, or use Conditional Access policies to meet more stringent requirements.
