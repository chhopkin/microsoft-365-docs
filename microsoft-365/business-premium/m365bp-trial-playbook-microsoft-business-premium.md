...
2. [Turn on multifactor authentication](/m365b-security/m365b-account-security) (MFA). You can use security defaults to get set up right away, or use Conditional Access policies to meet more stringent requirements.
...
- [Microsoft 365 Business Premium - cybersecurity for small business](/m365b-security/m365bp-security-benefits)
