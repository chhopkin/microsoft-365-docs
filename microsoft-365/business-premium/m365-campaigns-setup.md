...
4. In the top right of the page, find the **Preview on** control. Select **Preview on** so you can use all the controls described in [Configure your security protection for your campaign](/m365b-security/m365bp-security-overview).
...
Proceed to [set up your security protection](/m365b-security/m365bp-security-overview).
