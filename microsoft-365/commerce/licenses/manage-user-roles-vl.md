...
- VL roles provide access to agreements beyond the agreement end date. Admins need to remove VL roles of any users who's access they want to discontinue.
...
| Online services manager         | Online Services Manager    |Can view contracts and orders, activate services and manage reservations of online services _at __Billing > [Your products](https://go.microsoft.com/fwlink/p/?linkid=842054), [Volume licensing](https://go.microsoft.com/fwlink/p/?linkid=2244144)__ page. (Note an OSM must have Global Administrator permissions to also be able to manage and assign subscriptions on Billing > Licenses page)._|
