---
title: Extend your Microsoft 365 subscription with an Extended Service Term (EST)
f1.keywords:
- NOCSH
author: cmcatee-MSFT
ms.author: cmcatee
...
To convert to an EST subscription, you must currently have an active subscription. If your subscription already expired, you must reactivate it. For more information, see [Reactivate your subscription in the Microsoft 365 admin center](reactivate-your-subscription.md).
...
1. On the subscription details page, select **Edit recurring billing**.
1. In the **Renew or cancel this subscription** panel, select **Schedule a change to an extended service term**.
1. In the **Change to an extended service term** panel, review the details and select **Change Plan**.
1. The **Renew Subscription** panel opens. Select **Yes** to schedule the change to convert to an Extended Service Term subscription at the end of the term.
