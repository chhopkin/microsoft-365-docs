...
> During the **preview**, Autofill columns are visible only to users with an eligible Microsoft 365 Copilot license and do not require a separate Syntex pay-as-you-go setup. 
