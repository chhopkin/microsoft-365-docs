...
- Basic Mobility and Security, which is a subset of Intune services included with all Microsoft 365 products for managing devices in your organization. For more information, see [Overview of Basic Mobility and Security](/m365b-security/m365b-devices-basic-mobility-security-overview).
