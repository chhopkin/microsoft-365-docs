...
See [this article](/security/zero-trust/zero-trust-identity-device-access-policies-workloads#exchange-online-recommendations-for-zero-trust) for the recommended identity and device access policies to protect organizational email and email clients that support modern authentication and Conditional Access.
...
To protect SharePoint and OneDrive, see [this article](/security/zero-trust/zero-trust-identity-device-access-policies-workloads#sharepoint-recommendations-for-zero-trust) for the recommended identity and device access policies.
