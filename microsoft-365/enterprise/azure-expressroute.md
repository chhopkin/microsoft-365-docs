...
:::image type="content" source="../media/9d8bc622-4a38-4a3b-a0f3-68657712d460.png" alt-text="Microsoft 365 network connectivity.":::
...
:::image type="content" source="../media/251788c4-0937-4584-9b2c-df08e11611fc.png" alt-text="Microsoft 365 connectivity with ExpressRoute.":::
...
1. Determine the egress and peering locations for both internet and ExpressRoute traffic<sup>1</sup>.
1. Determine the capacity required on the internet and ExpressRoute connections.
1. Have a plan in place for implementing security and other standard perimeter controls<sup>1</sup>.
1. Have a valid Microsoft Azure account to subscribe to ExpressRoute.
1. Select a connectivity model and an [approved provider](/azure/expressroute/expressroute-locations). Keep in mind, customers can select multiple connectivity models or partners and the partner doesn't need to be the same as your existing network provider.
1. Validate deployment prior to directing traffic to ExpressRoute.
1. Optionally [implement QoS](https://support.office.com/article/ExpressRoute-and-QoS-in-Skype-for-Business-Online-20c654da-30ee-4e4f-a764-8b7d8844431d) and evaluate regional expansion.
...
Ready to sign up for [ExpressRoute for Microsoft 365](https://azure.microsoft.com/products/expressroute/)?
