...
>[!IMPORTANT]
>To ensure Teams media traffic is routed via the desired method in all VPN scenarios, ensure users are running Microsoft Teams client version **1.3.00.13565** or greater. This version includes improvements in how the client detects available network paths.
...
Information on how Teams mitigates common security concerns such as voice or *Session Traversal Utilities for NAT (STUN)* amplification attacks can be found in [5.1 Security Considerations for Implementers](/openspecs/office_protocols/ms-ice2/69525351-8c68-4864-b8a6-04bfbc87785c).
