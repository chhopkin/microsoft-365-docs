...
When managing shared agents for Copilot, you have visibility and control over agents that are shared within your organization. This control empowers you to monitor, govern, and act as needed.
...
As an admin, you can block or unblock shared agents in your organization. To do this action, sign in with one of the following roles:
...
1. Choose the agent and review details in the side pane.
