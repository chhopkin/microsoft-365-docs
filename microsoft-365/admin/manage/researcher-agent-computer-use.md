...
:::image type="content" source="media/computer-use-active-option.png" alt-text="Screenshot showing the computer use option active in Researcher agent." lightbox="/computer-use-active-option.png":::
