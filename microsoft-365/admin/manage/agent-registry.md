...
The **Risks** column on the Microsoft 365 admin center **All agents** page provides a unified view of aggregated high severity risks across Microsoft security platforms such as Entra, Microsoft Defender, and Purview. It closes a critical visibility gap for IT administrators responsible for governing AI agents. The **Risks** column is only available when a tenant has either an [Microsoft 365 E7](https://microsoftpartners.microsoft.com/abs/Blog/?title=Introducing%20Microsoft%20365%20E7:%20The%20Frontier%20Suite) license or a Microsoft 365 A365 license.
...
1. The **Risks** column appears in the table in the **All agents** page. If the **Risks** column doesn't appear, the tenant might not have either an Microsoft 365 E7 license or a Microsoft 365 A365 license.
...
> [!IMPORTANT]
>
> In order for a role to access Purview alerts, the role needs a **Insider Risk Management** (IRM) role in Purview so that it can log into Purview. For more information, see [Assign permissions in Insider Risk Management](/purview/insider-risk-management-permissions).
