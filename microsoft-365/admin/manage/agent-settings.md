...
Control which types of agents users can view and install from the agent catalog.
...
> [!TIP]
>
> If you disable an option, agents of that type won't appear for users in the Agent store.

### Sharing

Define who can share agents within your organization and how sharing works.
