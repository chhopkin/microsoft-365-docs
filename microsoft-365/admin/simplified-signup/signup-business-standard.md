...
- AdminSurgePortfolio
- VSBFY23
description: Learn how to sign up for Microsoft 365 Business Standard. Follow steps to choose the right plan, create your account, and set up your organization.
...
- [**Buy Microsoft 365 Business Standard**](https://go.microsoft.com/fwlink/?linkid=2109654): To purchase Microsoft 365 Business Standard, follow the steps in the [Sign up for Microsoft 365 Business Standard step by step](#sign-up-for-microsoft-365-business-standard-step-by-step) section of this article.

- **For Microsoft partners**: If you're a partner, see [Get Microsoft 365 Business](../../business/get-microsoft-365-business.md).

> [!IMPORTANT]
>
> Microsoft 365 Business Standard subscriptions are for commercial use and are intended for business and enterprise customers. If you're a consumer looking for Microsoft 365 for personal use, see [Microsoft 365 for individuals](https://www.microsoft.com/microsoft-365/explore-microsoft-365-for-individuals).
...
Additionally, if you later upgrade to an enterprise-level domain account ([option 2](#option-2-use-a-custom-business-domain)), users might choose not to transfer data created in apps such as MicrosoftOneDrive or Microsoft Teams.
...
For Microsoft 365 Business Standard frequently asked questions, see [Microsoft 365 Business Standard FAQ](signup-business-standard-faq.yml).
