...
|              | Interpreter       | Turning on Interpreter under the **More** icon and listening to a meeting in one of the selected languages.    | [Interpreter in Microsoft Teams meetings and calls](https://support.microsoft.com/office/interpreter-in-microsoft-teams-meetings-and-calls-c7efe2bb-535d-42ab-a5c4-d2d91619b46d)  |
|              | Facilitator       | Turning on Facilitator under the **More** icon and activating AI-generated notes; or interacting with Facilitator or Facilitator-generated content during or after a meeting.  | [Facilitator in Microsoft Teams meetings](https://support.microsoft.com/office/facilitator-in-microsoft-teams-meetings-37657f91-39b5-40eb-9421-45141e3ce9f6) |
...
| Word         | All Copilot in Word features are automatically included in the Microsoft 365 Copilot usage report. Usage of any Copilot in Word feature counts towards the Active users metric and is indicated in the per-user Last activity date (UTC).<br/><br/>**Note**: **Edit with Word** counts towards "Prompts submitted in Copilot Chat (work)," but **Edit with Excel** and **Edit with PowerPoint** do not. |  |  To learn more about Copilot in Word features, refer to [Welcome to Copilot in Word - Microsoft Support](https://support.microsoft.com/office/welcome-to-copilot-in-word-2135e85f-a467-463b-b2f0-c51a46d625d1). |
