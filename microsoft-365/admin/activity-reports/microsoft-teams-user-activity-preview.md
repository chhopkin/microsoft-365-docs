...
|Channel messages| Team Chat Message Count|The number of unique messages that the user posted in a team chat during the specified time period. This includes original posts and replies.|
...
|Total meetings|Meeting Count|Refer to the 'Total participated meetings' metric as defined below, as the current metric and ‘Total participated meetings’ share the same definition. We intend to gradually phase out the current metric with 'Total participated meetings.'|
