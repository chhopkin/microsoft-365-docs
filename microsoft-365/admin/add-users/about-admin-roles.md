...
|[User Administrator](/entra/identity/role-based-access-control/permissions-reference#user-administrator)     |    Assign the User Administrator role to users who need to do the following tasks for all users: <br/><br/> - Add users and groups<br> - Assign licenses<br> - Manage most users properties<br> - Create and manage user views<br> - Update password expiration policies<br> - Manage service requests<br> - Monitor service health <br><br>  The User Administrator can also perform the following tasks for other users who aren't administrators and who aren't assigned the Directory Reader, Guest Inviter, Helpdesk Administrator, Message Center Reader, or Reports Reader roles: <br> - Manage usernames<br> - Delete and restore users<br> - Reset passwords<br> - Force users to sign out<br> - Update (FIDO) device keys   |
