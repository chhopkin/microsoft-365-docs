...
|[Fabric Administrator](/entra/identity/role-based-access-control/permissions-reference) |   Assign the Fabric admin role to users who need to do the following tasks: <br> &bull; Manage all admin features for Microsoft Fabric and Power BI <br> &bull; Report on usage and performance <br> &bull; Review and manage auditing  |
