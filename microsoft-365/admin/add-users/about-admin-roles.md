...
|[SharePoint Administrator](https://learn.microsoft.com/en-us/entra/identity/role-based-access-control/permissions-reference#sharepoint-administrator)    |   Assign the SharePoint Administrator role to users who need to access and manage the SharePoint admin center. <br><br>SharePoint administrators can also: <br> &bull; Create and delete sites<br> &bull; Manage site collections and global SharePoint settings   |
