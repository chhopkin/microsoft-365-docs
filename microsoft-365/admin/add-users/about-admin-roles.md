...
| [SharePoint Advanced Management Administrator](/entra/identity/role-based-access-control/permissions-reference#sharepoint-advanced-management-administrator) | Assign the SharePoint Advanced Management Administrator role to users who need to perform the following kinds of tasks:<br/><br/>- Use the SharePoint Admin Agent<br/>- Create and manage back-up and restore points and policies<br/>- Create, manage, or delete Microsoft 365 groups excluding role-assignable groups<br/>- Manage all aspects of SharePoint Advanced Management<br/>- View names, paths, and URLs of files, folders, libraries, documents, and lists within SharePoint sites, without accessing file or item content <br/>- Remove permissions from files, folders, libraries, documents, and lists within SharePoint sites  |
