...
|---------|---------|
| [AI Administrator](/entra/identity/role-based-access-control/permissions-reference#ai-administrator) | Assign the AI Administrator role to users who need to do the following tasks:<br/><br>- Grant tenant-wide consent for apps and agents requesting permissions except Microsoft Graph application permissions<br/>- View basic subscription properties<br/>- View agents flagged as risky in [Identity Protection for agents](/entra/id-protection/concept-risky-agents)<br>- Allow users to install an app or install an app for users in the organization if the app doesn't require permission <br>- Read and configure Azure and Microsoft 365 service health dashboards <br>- View usage reports, adoption insights, and organizational insight <br>- Create and manage support tickets in Azure and the Microsoft 365 admin center<br/><br/>Apps or agents requiring Microsoft Graph application permissions continue to require Global Administrator approval.|
...
| [SharePoint Advanced Management Administrator](/entra/identity/role-based-access-control/permissions-reference#sharepoint-advanced-management-administrator) | Assign the SharePoint Advanced Management Administrator role to users who need to perform the following kinds of tasks:<br/><br/>- Use the [SharePoint Admin Agent](/sharepoint/content-governance-agent)<br/>- Create and manage back-up and restore points and policies<br/>- Create, manage, or delete Microsoft 365 groups excluding role-assignable groups<br/>- Manage all aspects of [SharePoint Advanced Management](/sharepoint/advanced-management)<br/>- View names, paths, and URLs of files, folders, libraries, documents, and lists within SharePoint sites, without accessing file or item content <br/>- Remove permissions from files, folders, libraries, documents, and lists within SharePoint sites  |
