...
If you get a message in the Microsoft 365 admin center that you don't have permissions to edit a setting or page, it's because you're assigned to a role that doesn't have that permission. Talk to another administrator to assign you the correct permissions or see [Assign administrator roles](assign-admin-roles.md) to assign yourself the correct role.
