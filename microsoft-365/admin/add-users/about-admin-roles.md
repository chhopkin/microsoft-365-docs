...
| AI Reader | Assign the AI Reader role to users who need to view administrator features and settings in the admin centers that AI administrators can view. The AI Reader can't edit any settings. |
