...
| [SharePoint Advanced Management Administrator](/entra/identity/role-based-access-control/permissions-reference#sharepoint-advanced-management-administrator) | Assign the SharePoint Advanced Management Administrator role to users who need to perform the following kinds of tasks:<ul><li>Use the [SharePoint Admin Agent](/sharepoint/content-governance-agent)</li><li>Create and manage back-up and restore points and policies</li><li>Create, manage, or delete Microsoft 365 groups excluding role-assignable groups</li><li>Manage all aspects of [SharePoint Advanced Management](/sharepoint/advanced-management)</li><li>View names, paths, and URLs of files, folders, libraries, documents, and lists within SharePoint sites, without accessing file or item content</li><li>Remove permissions from files, folders, libraries, documents, and lists within SharePoint sites</li></ul>  |
