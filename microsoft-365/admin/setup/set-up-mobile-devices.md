...
1. Enter your Microsoft 365 for business credentials and then select **Sign in**.
...
1. If your organization is protecting files in apps, the following message appears in a dialog:
    ...
    **Your organization is now protecting the data in the app. You need to restart the app to continue.**
    ...
    :::image type="content" source="../../media/fb4c1c84-b1e9-42e1-8070-c13dcf79fb09.png" alt-text="Screenshot of Outlook app showing organization protection message on iPhone.":::

    To restart Outlook, follow these steps:

   1. Select **OK** and close Outlook.

   1. Locate Outlook on the iPhone and then select it to reopen it.

   1. When prompted, enter a PIN and verify it.
...
1. In the dialog that states you must install the **Intune Company Portal** app, select **Go to store**.

    :::image type="content" source="../../media/a702d712-5622-45dd-a511-b1adaee63071.png" alt-text="Screenshot of Outlook app with Go to store button for Intune Company Portal on Android.":::

1. In the **Play Store**, select to install **Intune Company Portal**.

    :::image type="content" source="../../media/5e0408f2-3f37-44dd-80ed-13ca2ac6df0c.png" alt-text="Screenshot of Google Play Store with install button for Intune Company Portal app.":::

1. Open Outlook again.

1. Enter and confirm a PIN.
