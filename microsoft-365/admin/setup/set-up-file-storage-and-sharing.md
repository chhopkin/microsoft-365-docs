...
#customer intent: As an IT admin for a small business, I want to set up OneDrive and SharePoint for file storage and sharing so that my team can collaborate effectively.
---
...
One of the best ways to set up file storage and sharing for your business is to use OneDrive and a team site together. This method is ideal if you have a small business with a few employees.
...
If you found this video helpful, check out the [complete training series for small businesses and for businesses new to Microsoft 365](../../business-video/index.yml).
...
- A team site is designed for sharing and collaborating on files regularly. A team site is ideal for storing files with shared ownership where several people own the files and might collaborate on them. Create a Microsoft Team to add a team site. [Learn more at Create a team in Microsoft Teams](https://support.microsoft.com/office/174adf5f-846b-4780-b765-de1a0a737e2b).
...
- **Businesses with external clients or partners who need access to files**: Create a new team site to store and share documents intended for a specific customer. Set up the site to allow access to only that customer. You then don't need to worry that one customer can accidentally get access to information intended for another customer.

### Keep private files private

When you store a file in OneDrive, only you can access it unless you share it with others. When you share files, you can choose to create a link that others can forward, or you can share with only specific people. You can also create separate folders in OneDrive for different purposes such as public, personal, or for individual projects. Each folder can be shared with a different person or group, or nobody else.
...
### Track how much space is available

To see how much storage space is available in OneDrive, see [Manage your OneDrive for work or school storage](https://support.microsoft.com/office/31519161-059C-4764-B6F8-F5CD29F7FE68).
...
You can enable third-party storage for your users in Microsoft 365 so they can store and share documents by using services like Dropbox in addition to OneDrive and team sites. Enabling third-party storage can be a great way to provide services that your users might already be using or prefer to use for business projects. If you don't want people in your organization using Microsoft 365 to open files in a third-party service, follow these steps to turn it off.
  
> [!IMPORTANT]
> Third-party storage is enabled by default. If you don't want it available to your users, then complete these steps right away.
  
1. Sign in to the [Microsoft 365 admin center](https://go.microsoft.com/fwlink/p/?linkid=2024339).

1. Go to **Settings** >[**Org settings**](https://go.microsoft.com/fwlink/p/?linkid=2053743)

1. On the **Services** tab, select **Microsoft 365 on the web**.

1. Select or clear the checkbox to let users open files stored in third-party storage services in Microsoft 365 on the web, and then select **Save**.

## Next steps

- [Customize your team site for file storage and sharing](customize-team-site.md). This step-by-step tutorial shows you how to take advantage of more storage and collaboration features.
...
- **Set up Microsoft 365 productivity apps on your tablets and phones.** You need to do this setup so you can **edit** files that are stored in OneDrive and on team sites from your tablet or phone. If you don't install the apps for your tablet or phone, you can still view the files but not edit them.
