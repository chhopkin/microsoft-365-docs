...
|&nbsp;&nbsp;The Microsoft Defender Suite|||Purchased separately<br/>(includes Microsoft Entra ID P2)|
|**Email and collaboration security**||||
|&nbsp;&nbsp;Default email protections for cloud mailboxes|✔|✔|✔|
|&nbsp;&nbsp;Microsoft Defender for Office 365|||Plan 1|
|&nbsp;&nbsp;The Microsoft Defender Suite|||Purchased separately<br/>(includes Defender for Office 365 Plan 2)|
|**Device and computer security**||||
|&nbsp;&nbsp;Basic Mobility and Security|✔|✔|✔|
|&nbsp;&nbsp;Microsoft Intune|||Plan 1|
|&nbsp;&nbsp;Microsoft Defender for Business|||✔|
|&nbsp;&nbsp;The Microsoft Defender Suite|||Purchased separately<br/>(includes Defender for Endpoint Plan 2)|
...
- **Ability to add the Microsoft Defender Suite**: If you choose to buy this additional subscription, you get the following upgraded features:
  ...
  For more information, see [Add the Microsoft Defender Suite to your Microsoft 365 Business Premium subscription](m365bp-add-m365e5s.md).
