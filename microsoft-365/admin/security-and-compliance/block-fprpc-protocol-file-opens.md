...
The Group Policy setting **Restrict Apps from FPRPC Fallback** can be found in the following path and registry key:
...
- Registry key path: `HKCU\Software\Microsoft\Office\16.0\Common\FileIO\BlockWecFallback`
