...
description: Get an overview of the Microsoft Defender Suite and learn how to add it to your Microsoft 365 Business Premium subscription.
search.appverid:
- MET150
- BCS160
ms.author: chrisda
...
You can now extend the security capabilities you have in Microsoft 365 Business Premium by adding the Microsoft Defender Suite to your subscription. Adding the Microsoft Defender Suite to Microsoft 365 Business Premium provides your business with even more protection in a cost-effective solution.

**See the [Tech Community Blog: the Microsoft Defender Suite is now available as an add-on to Microsoft 365 Business Premium](https://aka.ms/BusinessPremiumPlusE5SecurityBlog).**

### the Microsoft Defender Suite at a glance
...
:::image type="content"source="../../media/m365e5s-components.png" alt-text="Diagram that shows the components of the Microsoft Defender Suite.":::

### Compare the upgraded features in the Microsoft Defender Suite
...
To get the Microsoft Defender Suite, you have the following options:
