...
- You can now add the Microsoft Defender Suite to your Microsoft 365 Business Premium subscription. the Microsoft Defender Suite up levels your security capabilities with more protection for your organization's identities, devices, email, files, and apps. For more information, see the following resources:
  - [Tech Community Blog: The Microsoft Defender Suite is now available as an add-on to Microsoft 365 Business Premium](https://aka.ms/BusinessPremiumPlusE5SecurityBlog)
  - [Add the Microsoft Defender Suite to your Microsoft 365 Business Premium subscription](m365bp-add-m365e5s.md)
