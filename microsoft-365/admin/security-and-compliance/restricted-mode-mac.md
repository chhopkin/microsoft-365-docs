...
|Block OLE graph and OrgChart objects | Block OLE Graph and OrgChart objects. When you turn on this setting, Microsoft 365 apps will block loading OLE Graph and OrgChart objects to protect users from known exploitation techniques.  <br/><br/> For more information, see [Block Dynamic Data Exchange (DDE) server launches in Excel](block-dde-server-launches-excel.md). |
